...
function Intro() {
    return (
        <div className="flex items-center justify-center flex-col text-center pt-20 pb-6">
            ...
            <p className="text-sm max-w-xl mb-6">I'm a {age} year old student about to graduate from Novia UAS with a bachelors degree in electrical engineering with a specialization in IT.
